 ...
 * @LastEditors: Lw
 * @LastEditTime: 2021-10-08 16:52:14
 */
...
const componentsRouter: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      ...
      {
        path: '/back-to-top',
        component: () => import(/* webpackChunkName: "BackToTop" */ '@/views/components-demo/BackToTopDemo.vue'),
        name: 'BackToTopDemo',
        meta: {
          title: 'backToTop',
          noCache: true
      ...
      {
        path: '/count-to',
        component: () => import(/* webpackChunkName: "CountTo" */ '@/views/components-demo/CountToDemo.vue'),
        name: 'CountToDemo',
        meta: {
          title: 'countTo',
          noCache: true
      ...
      {
        path: '/sticky',
        component: () => import(/* webpackChunkName: "sticky" */ '@/views/components-demo/StickyDemo.vue'),
        name: 'StickyDemo',
        meta: {
          title: 'sticky',
          noCache: true
      ...
      {
        path: '/componentMixin',
        component: () => import(/* webpackChunkName: "componentMixin" */ '@/views/components-demo/MixinDemo.vue'),
        name: 'MixinDemo',
        meta: {
      ...
      {
        path: '/draggable-list',
        component: () => import(/* webpackChunkName: "CountTo" */ '@/views/components-demo/DraggableListDemo.vue'),
      ...
      },
      {
        ...
        component: () => import(/* webpackChunkName: "CountTo" */ '@/views/components-demo/DraggableSelectDemo.vue'),
